...
public class SkeletonDuster extends EntitySkeleton {
	...
	public SkeletonDuster(){
		sklaSkeleton = new SkeletonLimb[] {
				new LimbLine(3f, 0.0,3.0,  0.0,-12.0), //Limb 0, handle&stock
				new LimbLine(1f, 0.0,-6.0,  3.0,-4.0), //Limb 1, String, right bottom
				new LimbLine(1f, 0.0,-8.0,  3.0,-6.0), //Limb 2, String, right bottom-middle
				new LimbLine(1f, 0.0,-10.0,  3.0,-8.0), //Limb 3, String, right top-middle
				new LimbLine(1f, 0.0,-12.0,  3.0,-10.0), //Limb 4, String, right top
				new LimbLine(1f, 0.0,-6.0,  -3.0,-4.0), //Limb 5, String, left bottom
				new LimbLine(1f, 0.0,-8.0,  -3.0,-6.0), //Limb 6, String, left bottom-middle
				new LimbLine(1f, 0.0,-10.0,  -3.0,-8.0), //Limb 7, String, left top-middle
				new LimbLine(1f, 0.0,-12.0,  -3.0,-10.0) //Limb 8, String, left top.
		};
